...
async function readJsonDb() {
  try {
    ...
    return { projects: [], leads: [], reviews: [], content: {}, blogs: [], capacities: [] }
  }
}
...
export async function readDb() {
  ...
  try {
    ...
    const contentRes = await client.query("SELECT key, value FROM content WHERE key IN ('site_content', 'blogs_data', 'capacities_data')")
